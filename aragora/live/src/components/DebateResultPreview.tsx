  ...
  return (
    <div className="text-left space-y-4 mt-8">
      ...
      {(() => {
        ...
        return (
          <div>
            <h3 className="text-sm text-[var(--accent)] mb-4 font-bold">
              Proposals
            </h3>
            ...
            {result.critiques.slice(0, 3).map((c, i) => (
              ...
              >
                <div className="text-xs mb-2 flex items-center gap-2">
                  ...
                  />
                  <span className="font-bold" style={{ color: agentDot(c.agent) }}>{c.agent}</span>
          ...
          <div className="space-y-2">
            {result.votes.map((v, i) => (
              ...
              >
                ...
                />
                <span className="font-bold" style={{ color: agentDot(v.agent) }}>{v.agent}</span>
      ...
      {result.final_answer && !(
        ...
        <div className="rounded-2xl border border-[var(--accent)]/20 bg-[var(--surface)] p-6">
          <h3 className="text-sm text-[var(--accent)] mb-3 font-bold">
            Verdict
          </h3>
          ...
          {result.dissenting_views.length > 0 && (
            <div className="mt-4 pt-4 border-t border-[var(--border)]">
              ...
              {result.dissenting_views.map((view, i) => (
                <div key={i} className="text-xs text-[var(--text-muted)] leading-relaxed mb-2 [&_p]:mb-1.5 [&_strong]:text-[var(--text)]">
      ...
      <div className="rounded-2xl border border-[var(--accent)]/20 bg-[var(--surface)] p-6">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs mb-5">
          ...
          <div>
            <span className="text-[var(--text-muted)] block text-[10px] uppercase tracking-wider mb-0.5">Verdict</span>
