---
title: Aragora User Onboarding Guide
description: Aragora User Onboarding Guide
---
...
| Goal | Guide |
|------|-------|
| Run adversarial stress-tests | [GAUNTLET.md](./gauntlet) |
| Build custom agents | [CUSTOM_AGENTS.md](./custom-agents) |
| Troubleshoot issues | [TROUBLESHOOTING.md](../operations/troubleshooting) |
| API integration | [API_REFERENCE.md](../api/reference) |
| Self-improving debates | [NOMIC_LOOP.md](../admin/nomic-loop) |
