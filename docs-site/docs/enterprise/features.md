...
*See [COMMERCIAL_OVERVIEW.md](./commercial-overview) for pricing and deployment tiers. See [WHY_ARAGORA.md](./why-aragora) for competitive positioning. See [status/STATUS.md](../contributing/status) for detailed feature implementation status.*
