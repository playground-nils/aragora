---
title: ELO Rating and Calibration System
description: ELO Rating and Calibration System
---
...
- [Consensus Mechanism](./consensus) - How consensus is determined
- [Convergence Detection](./convergence-algorithm) - How convergence is detected
- [Agent Selection](./agent-selection) - How agents are selected for debates
