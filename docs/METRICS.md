...
| Test functions (class + module level) | `218730` | `tests/` | `git grep -E '^[[:space:]]*(async )?def test_' -- tests \| wc -l` |
...
| Markdown files under docs/ | `932` | `docs/` | `git ls-files docs \| grep -E '\.md$' \| wc -l` |
