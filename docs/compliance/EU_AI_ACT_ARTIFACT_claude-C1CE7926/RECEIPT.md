...
This artifact is the external-proof deliverable for the 2026-05-20 substrate-soak run (per local founder guidance; source path redacted). No new tooling, no new orchestration verbs -- the artifact is produced by existing CLI commands shipped on main (`aragora compliance eu-ai-act generate`, polished for GTM in PR #725 / Mar 6, 2026).
