...
ENTRYPOINT_INVENTORY: Final[tuple[BackboneEntrypoint, ...]] = (
    ...
    BackboneEntrypoint(
        ...
        wiring_mode="legacy_create",
        signals=("decision_plan_factory", "store_plan"),
    ),
    BackboneEntrypoint(
        file_path="aragora/server/handlers/debates/implementation.py",
    ...
    BackboneEntrypoint(
        ...
        coverage="legacy_bypass",
        wiring_mode="legacy_create",
        signals=("decision_plan_ctor", "plan_store_create"),
    ),
    BackboneEntrypoint(
        file_path="aragora/server/handlers/plans.py",
        ...
        lifecycle="execute",
        coverage="reuse_only",
        wiring_mode="execution_bridge_only",
        signals=("bridge_schedule_execution",),
    ),
    BackboneEntrypoint(
        file_path="aragora/server/handlers/plans.py",
